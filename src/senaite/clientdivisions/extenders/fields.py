...
class DivisionExtensionField(object):
    """Mix-in class to make Archetypes fields not depend on generated
    accessors and mutators, and use AnnotationStorage by default.
    """
    ...
    def __init__(self, *args, **kwargs):
        super(DivisionExtensionField, self).__init__(*args, **kwargs)
        self.args = args
        self.kwargs = kwargs
...
class ExtDivisionField(DivisionExtensionField, UIDReferenceField):
    "Field extender"
